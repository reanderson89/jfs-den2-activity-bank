...
const welcome = () => {
    ...
    console.log(" ");
    console.log("Please read the questions carefully for each 'prompt' because they will explain what each one is doing. When you are ready use the command 'node example.js' to start the application.".brightGreen);
